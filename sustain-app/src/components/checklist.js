      ...
      <div>
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group">
            <label className="form-check-label"> Do you have Solar Panels or Solar Water Heater at home?  </label>
          ...
          <div className="form-group">
            <label className="form-check-label">Do you have Grey Water system at home?</label>
            <div className="form-check form-check-inline">
          ...
          <div className="form-group">
            <label className="form-check-label">Do you have Cooling roof at home?</label>
            <div className="form-check form-check-inline">
          ...
          <div className="form-group">
            <label className="form-check-label">Do you have Energy star rated Kitchen appliances at home?</label>
            <div className="form-check form-check-inline">
          ...
          <div className="form-group">
            <label className="form-check-label">Do you have Natural shading at home?</label>
            <div className="form-check form-check-inline">
          ...
          <div className="form-group" align="center">
            <input className="btn btn-success" type="submit" value="Credit Score"  />
          </div>
        </form>
      </div>
    );
